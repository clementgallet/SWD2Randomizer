        ...
        public LocationsCasual() {
            Locations = new List<Location>
            {
                ...
                new Location
                {
                    Name = "main_yarrow",
                    Grant = "main_yarrow",
                    CanAccess = have => have.Contains("top_yarrow") && ((have.Contains("pressurebomb") && have.Contains("pressurebomb.launcher")) || have.Contains("steampack"))
                },
                new Location
                {
                ...
                new Location
                {
                    Name = "oasis",
                    Grant = "oasis",
                    CanAccess = have => (have.Contains("archaea_barrier") && have.Contains("break_rocks")) || (have.Contains("main_yarrow") && have.Contains("steampack") && have.Contains("steampack.slayer")) || (have.Contains("middle totd") && have.Contains("pickaxe.fire"))
                },
                new Location
                {
                    Name = "bottom_archaea",
                    Grant = "bottom_archaea",
                    CanAccess = have => have.Contains("archaea_barrier") && have.Contains("jackhammer")
                },
                new Location
                {
                    Name = "top_totd",
                ...
                new Location
                {
                    Name = "middle_totd",
                    Grant = "middle_totd",
                    CanAccess = have => (have.Contains("top_totd") && have.Contains("jackhammer")) || (have.Contains("archaea_barrier") && have.Contains("jackhammer") && (have.Contains("hook") || have.Contains("steampack"))) || (have.Contains("oasis") && have.Contains("pressurebomb") && (have.Contains("hook") || have.Contains("steampack")))
                },
                new Location
                {
                    Name = "lava_pit",
                    Grant = "lava_pit",
                    CanAccess = have => have.Contains("middle_totd") && ((have.Contains("hook") && have.Contains("hook.long_hook")) || have.Contains("steampack"))
                },
                new Location
                {
                ...
                new Location
                {
                    ...
                    Type = Location.RandomizeType.Upgrade,
                    CanAccess = have => (have.Contains("hook") || have.Contains("steampack")) && have.Contains("pressurebomb.launcher")
                },
                new Location
                {
                    Name = "jackhammer",
                    Grant = "jackhammer",
                    Type = Location.RandomizeType.Upgrade,
                    CanAccess = have => have.Contains("archaea_cave_jackhammer") && (have.Contains("pressurebomb") || have.Contains("jackhammer")),
                ...
                new Location
                {
                    ...
                    CanEscape = have => have.Contains("hook") || have.Contains("steampack"),
                ...
                new Location
                {
                    ...
                    Type = Location.RandomizeType.Upgrade,
                    CanAccess = have => have.Contains("yarrow_barrier_1") && have.Contains("steampack"),
